  ...
  return (
    <div className="fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 18, marginBottom: 24 }}>
        ...
        <StatCard icon={<Icon.Dollar size={24}/>} label="Orçamento total" value={`${totalBudget.toLocaleString('pt-PT')}€`} color="#3A6EA5" accent="radial-gradient(circle, rgba(58,110,165,0.3), transparent)"/>
